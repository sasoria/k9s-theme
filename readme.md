...
2. Create a folder  `$XDG_CONFIG_HOME/k9s/skins/`
3. Copy the skins to that directory
4. Select the skin in `$XDG_CONFIG_HOME/k9s/config.yaml`
```yaml
k9s:
  ui:
    skin: rose-pine
...
```sh
npx @rose-pine/build@0.9.1 -t ./template.yaml -o ./
```
